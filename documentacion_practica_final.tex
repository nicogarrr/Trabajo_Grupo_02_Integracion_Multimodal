...
\begin{center}
\codepath{Entrenamiento_Gestos (1).ipynb}
\end{center}
...
\begin{itemize}
    ...
    \item \codepath{Entrenamiento_Gestos (1).ipynb}: cuaderno usado para el entrenamiento.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{figuras/Imagen_Main.png}\\[0.35cm]
    \includegraphics[width=0.92\linewidth]{figuras/Imagen_Main2.png}
    \caption{Consola de \codepath{main_chef_zero_waste.py} clasificando texto y publicando \codepath{event_text.json}.}
    \label{fig:captura-chat-pln}
\end{figure}
...
\begin{figure}[H]
    \centering
    \IfFileExists{capturas/ampliacion_a.png}{
        \includegraphics[width=0.92\linewidth]{capturas/ampliacion_a.png}
    }{
        \fbox{
            \begin{minipage}[c][5.5cm][c]{0.88\linewidth}
                \centering
                \textbf{Captura pendiente}\\[0.25cm]
                Guardar como \codepath{capturas/ampliacion_a.png}\\[0.25cm]
                Evidencia de funcionamiento de la ampliacion A.
            \end{minipage}
        }
    }
    \caption{Evidencia de funcionamiento de la ampliacion A con CLIP.}
    \label{fig:ampliacion-a}
\end{figure}
